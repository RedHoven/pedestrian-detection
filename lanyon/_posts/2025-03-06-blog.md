...
Overall, RT-DETR outperforms YOLOv8, likely due to its advanced attention mechanism. Transferring from pedestrian-trained models is less effective than using default COCO weights, and freezing the backbone appears to limit performance rather than speed up learning.
...
**Figure 5** <a id="figure-5"></a>: LIME visualization with a lot of people of different scale. Green boxes denote ground truth bounding boxes, red boxes denote predicted bounding boxes with corresponding confidence scores.
...
- <a id="ref-lin"></a> Tsung-Yi Lin et al. Microsoft COCO: Common Objects in Context. 2015. arXiv: 1405.0312 [https://arxiv.org/abs/1405.0312](https://arxiv.org/abs/1405.0312)
