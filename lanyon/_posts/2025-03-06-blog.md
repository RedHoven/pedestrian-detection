...
TODO: Explain why matters and how they are related.

In order to do that, we used the dataset from: [Traffic Sign Detection](https://universe.roboflow.com/selfdriving-car-qtywx/self-driving-cars-lfjou).
...
We used 2 fine-tuning approaches: Full Fine-Tuning vs Partial. As previously, we trained the YOLOv8 model for 50 epochs and RT-DETR for 35 epochs.
