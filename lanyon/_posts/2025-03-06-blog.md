...
In the following graph we show the validation metrics during the learning procedure against the epochs:

![Robustness Comparison]({{ '/public/images/tl_training_epochs.png' | relative_url }})
_Figure X: ...

In the next graph, we show how the validation metrics during the learning procedure against the training time:
